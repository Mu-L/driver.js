...
- Hints — pulsing beacons that open a popover on click; no overlay, the page
  stays interactive. New `driver.js/hints` entry, ~5KB gzip.
...
- Optional hint overlay (`overlay`, `overlayColor`, `overlayOpacity`) — dims the
  page around the open hint's element, tour-style cutout included.
