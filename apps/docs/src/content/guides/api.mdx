---
title: "API Reference"
description: "Complete Driver.js API reference: drive, moveNext, highlight, destroy, getActiveStep and every method available on the driver instance, with examples."
